<?php
requi# Replicate the exact query from comprehensive endpoint
...
echo "- Different completion rate calculation\n";
echo "\nThis explains why you only see Medium/High - the criteria are more lenient.\n";
?>
